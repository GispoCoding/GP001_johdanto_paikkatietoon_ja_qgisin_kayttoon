...
Seuraavaksi suodatetaan tämän uuden tason sisältö vastaamaan nimeä. Klikkaa **Tie 66** -tasoa hiiren oikealla painikkeella ja valitse **Suodata…**. Syötä **Suodattimena käytettävä lauseke** -kohtaan seuraava lauseke:
