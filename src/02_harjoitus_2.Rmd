...
QGISin käyttöliittymä saattaa aueta englanninkielisenä ensimmäisellä käyttökerralla, mutta voit vaihtaa kielen suomeksi valitsemalla QGISin ylävalikosta Asetukset > Valinnat ja tämän jälkeen Yleiset > Käyttöliittymän kielisyys > suomi. Paina lopuksi OK.
![]img/harjoitus2/image1.png
...
Sisältö
.shp
Aineiston geometriatiedot
.prj
Käytetyn koordinaattijärjestelmän määritelmä
.dbf
Paikkatiedon ominaisuustietotaulu (attribuuttitaulu)
...
Sisältö
.shx
Geometriatietojen indeksi
.sbn/.sbx
Spatiaalinen indeksi
.cpg
Kirjainmerkistön koodi
...
## 3. Selain-paneeli
Tutustuimmekin jo hieman QGISin Selain-paneeliin. Tästä paneelista löydät erilaisia kansiopolkuja.
...
## 5. Hakutoiminto
QGISin hakutoiminnolla löydät kätevästi esimerkiksi työkalujen ja toimintojen sijainnit.

## 6. Tilapalkki
Tilapalkista löydät hiiren kursorin koordinaatit (joko metreinä tai leveys- ja pituusasteina), mittakaavan, suurennuksen, kierron, projektin koordinaattijärjestelmän sekä QGISin lokiviestit. Tilapalkista pääset nopeasti muuttamaan mm. projektin koordinaattijärjestelmää.
...
![]img/harjoitus2/image7.png

Paikanna edellä näkyneestä työkalurivistä seuraavat työkalut ja tunnista niiden tarkoitukset:

Zoomaa täydeksi  ![]img/harjoitus2/image8.png

Zoomaa tasoon  ![]img/harjoitus2/image9.png

Näytä kohteen tiedot  ![]img/harjoitus2/image10.png

Avaa attribuuttitaulu  ![]img/harjoitus2/image11.png

Mittaa viivan pituus  ![]img/harjoitus2/image12.png



Kokeile myös **tilapalkin** ja **tasoluettelon** toimintoja.

![]img/harjoitus2/image13.png

![]img/harjoitus2/image14.png


## Paikkatietoaineiston kohteiden valinta
Kokeile työkalua **Valitse kohteet** ![]img/harjoitus2/image15.png . Klikkaa työkalu aktiiviseksi ja piirrä kartalle suorakaide. Kaikki Tieviiva-tason elementit, jotka osuvat edes osittain valintarajauksesi sisään, korostuvat keltaisella.

![]img/harjoitus2/image16.png

Avaa nyt **tason attribuuttitaulu** joko ![]img/harjoitus2/image17.png -painikkeella tai klikkaamalla tasoluettelossa tasoa hiiren oikealla napilla ja valitsemalla **Avaa attribuuttitaulu**. Kaikki ne tie-elementit, jotka tulivat kartalta valituksi, ovat korostuneet taulussa sinisellä. Voit suodattaa attribuuttitaulun näkymää sen vasemmasta alanurkasta ja näyttää vain valitut kohteet:

![]img/harjoitus2/image18.png

Poista aineiston valinta klikkaamalla **Poista valinnat kaikilta tasoilta -painiketta** ![]img/harjoitus2/image19.png , joka löytyy attribuuttitaulun työkalupalkista.
...
Suodatusehtoina voit käyttää esim. suurempi kuin -, pienempi tai yhtä suuri kuin -, tai erisuuri kuin -operaattoreita. Voit myös yhdistellä eri kenttien ehtoja AND- ja OR-operaattoreilla. Muistutuksena siitä, että aineistoa on suodatettu, tasoluettelossa näkyy pieni suppilokuvake ![]img/harjoitus2/image22.png . Tätä kuvaketta klikkaamalla voit milloin tahansa palata suodatinlausekkeeseen, muokata sitä tai poistaa sen. 

![]img/harjoitus2/image23.png
