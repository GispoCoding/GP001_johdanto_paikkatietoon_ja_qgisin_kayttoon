...
Zoomaa täydeksi  ![]img/harjoitus2/image7.png

Zoomaa tasoon  ![]img/harjoitus2/image8.png

Näytä kohteen tiedot  ![]img/harjoitus2/image9.png

Avaa attribuuttitaulu  ![]img/harjoitus2/image10.png

Mittaa viivan pituus  ![]img/harjoitus2/image11.png



Kokeile myös **tilapalkin** ja **tasoluettelon** toimintoja.

![]img/harjoitus2/image12.png

![]img/harjoitus2/image13.png


## Paikkatietoaineiston kohteiden valinta
Kokeile työkalua **Valitse kohteet** ![]img/harjoitus2/image14.png . Klikkaa työkalu aktiiviseksi ja piirrä kartalle suorakaide. Kaikki Tieviiva-tason elementit, jotka osuvat edes osittain valintarajauksesi sisään, korostuvat keltaisella.

![]img/harjoitus2/image15.png

Avaa nyt **tason attribuuttitaulu** joko ![]img/harjoitus2/image16.png -painikkeella tai klikkaamalla tasoluettelossa tasoa hiiren oikealla napilla ja valitsemalla **Avaa attribuuttitaulu**. Kaikki ne tie-elementit, jotka tulivat kartalta valituksi, ovat korostuneet taulussa sinisellä. Voit suodattaa attribuuttitaulun näkymää sen vasemmasta alanurkasta ja näyttää vain valitut kohteet:

![]img/harjoitus2/image17.png

Poista aineiston valinta klikkaamalla **Poista valinnat kaikilta tasoilta -painiketta** ![]img/harjoitus2/image18.png , joka löytyy attribuuttitaulun työkalupalkista.
...
Suodatusehtoina voit käyttää esim. suurempi kuin -, pienempi tai yhtä suuri kuin -, tai erisuuri kuin -operaattoreita. Voit myös yhdistellä eri kenttien ehtoja AND- ja OR-operaattoreilla. Muistutuksena siitä, että aineistoa on suodatettu, tasoluettelossa näkyy pieni suppilokuvake ![]img/harjoitus2/image21.png . Tätä kuvaketta klikkaamalla voit milloin tahansa palata suodatinlausekkeeseen, muokata sitä tai poistaa sen. 

![]img/harjoitus2/image22.png
