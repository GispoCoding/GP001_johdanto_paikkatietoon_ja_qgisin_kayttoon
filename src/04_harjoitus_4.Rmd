...
![](img/harjoitus_4/image6.png) ![](img/harjoitus_4/image7.png)
...
Voit huomata, että koordinaattien suuruusluokka on hyvin erilainen. Tämä johtuu siitä, että aineistoilla on eri koordinaattijärjestelmät. ETRS89/TM35FIN-koordinaattijärjestelmän mittasuhteet ovat metreinä (itä ja pohjoinen / x ja y), kun taas WGS 84 -koordinaattijärjestelmässä mittasuhteet ovat asteina (pituus ja leveys). ETRS89/TM35FIN-koordinaattijärjestelmässä on määritetty origo eli piste, jonka koordinaatit ovat (0, 0). ETRS89/TM35FIN-koordinaattijärjestelmässä taas sama piste sijaitsee päiväntasaajalla UTM-kaistalla 35. UTM on maailmanlaajuisesti käytössä oleva projektio, joka jakaa maapallon 6° kaistoihin. Kaista UTM01 sijaitsee Alaskan länsipuolella. Koska koordinaattijärjestelmien arvoja voidaan ilmentää sekä metreinä että asteina, niiden koordinaattiarvoja ei voida suoraan vertailla toisiinsa. Koordinaatit tulee uudelleenprojisoida yhteiseen koordinaattijärjestelmään.
...
Toisinaan on tärkeää, että paikkatietoaineistot ovat samassa koordinaattijärjestelmässä – esimerkiksi osa QGISin prosessityökaluista ei tuota oikeaa tulosta jos aineistot ovat eri koordinaattijärjestelmissä. Näin ollen paikkatietoaineisto on uudelleenprojisoitava ja tallennettava uutena paikkatietoaineistona. Uudelleenprojisoidaan nyt **ne_10m_populated_places_suomi-taso** WGS 84 -koordinaattijärjestelmästä ETRS89/TM35FIN-koordinaattijärjestelmään. 
